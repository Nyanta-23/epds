...
interface RecomendationVariationActionProps {
  // filter: Filter;
  meta: Meta;
}

export default function RecomendationVariationAction({ meta }: RecomendationVariationActionProps) {
    ...
    <section className="grid auto-rows-min gap-4">
      ...
      <div className="me-4 flex justify-between">
        <div className="flex items-center gap-5">
          <div>
            {/* <Search total={total} link={'tone'} filter={filter} /> */}
          </div>

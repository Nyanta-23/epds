...
interface RecomendationRuleFormActionProps {
  process: boolean;
  action: () => void;
}

export default function RecomendationRuleFormAction({ process, action }: RecomendationRuleFormActionProps) {

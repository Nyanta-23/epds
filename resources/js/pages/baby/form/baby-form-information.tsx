...
export default function BabyFormInformation({
    data,
    errors,
    process,
    handleInputChange,
    ...
    return (
        <div className="space-y-4 p-6">
            <div>
                ...
                <div className="relative">
                    <Select
                        ...
                        onValueChange={(value) =>
                            handleInputChange('mother_id', value)
                        }
                        required
                    >
                        <SelectTrigger
                            id="mother-select"
                            className={`w-full cursor-pointer ${identityErrorClassName('mother_id')}`}
                        >
            ...
            <div>
                <Label className="mb-2 block text-sm font-medium">
                    Kondisi Bayi <span className="text-red-500">*</span>
                </Label>
                <div className="relative">
                    <Select
                        value={
                            data.baby_condition !== null
                                ? String(data.baby_condition)
                                : undefined
                        }
                        onValueChange={(value) =>
                            handleInputChange('baby_condition', Number(value))
                        }
                        required
                    >
                        <SelectTrigger
            ...
            <div>
                <Label className="mb-2 block text-sm font-medium">
                    Jenis Persalinan <span className="text-red-500">*</span>
                </Label>
                ...
                <div className="relative">
                    <Select
                        ...
                        onValueChange={(value) =>
                            handleInputChange('typeof_delivery', Number(value))
                        }
                        required
                    >
                        <SelectTrigger
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    >
                        <SelectTrigger
                            id="typeof-delivery-select"
                            className={`w-full cursor-pointer ${identityErrorClassName('baby_feeding_method')}`}
                        >
                            <SelectValue placeholder="Select Type of Delivery" />
                        </SelectTrigger>

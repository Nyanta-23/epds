...
interface BabyActionFormProps {
  process: boolean;
  action: () => void;
}

export default function BabyActionForm({ process, action }: BabyActionFormProps) {
    ...
    <div className="flex items-center justify-start space-x-3 pt-6">
      {process ? (
        ...
        <ButtonConfirmation
          content={{
            title: 'Are you sure?',
            description: 'This will create and publish the baby.'
          }}
          onConfirm={action}
        >
          <Button
